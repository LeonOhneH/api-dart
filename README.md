...
- **Team (Mannschaft):** `/api/team/{id}`, `/api/team/table/{id}`, `/api/team/next_games/{id}`, `/api/team/prev_games/{id}`, `/api/team/squad/{id}`, `/api/team/matches/{team_id}?club-id={club_id}`
